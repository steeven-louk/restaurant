...
const Slider = () => {
  ...
  return (
    <div className='flex flex-col h-[calc(100vh - 6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-fuchsia-50'>
      {/* TEXT CONTAINER */}
      <div className="flex-1 h-1/2 flex items-center justify-center flex-col gap-8 text-red-500 font-bold lg:h-full lg:w-1/2">
      ...
      {/* IMAGE CONTAINER */}
      <div className="w-full flex-1 relative h-1/2 lg:h-full lg:w-1/2">
